...
it is available for this repository. If that is not available, open a minimal
public issue that requests a maintainer security contact without including
exploit details, secrets, private endpoints, or sensitive logs.
